...
func main() {
	...
	consoleHandler := handlers.NewConsoleHandler(redisClient, serverRepo)
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins: []string{
			"http://localhost:5173",
			"http://localhost:3000",
			"https://craft4free.com",     // Add production frontend
			"https://www.craft4free.com", // Add www variant
		},
	...
	routes.SetupRoutes(r, cfg, serverHandler, consoleHandler)
